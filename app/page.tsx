...
import {ArrowDown, ArrowRight, BookOpen, Crown, Heart} from 'lucide-react';
...
export default function Home() {
    ...
    const dailyKuralContent = () => {
        ...
        if (hasError || !kural) {
            return (
                <p role="alert"
                   className="rounded-2xl border border-white/20 bg-white/10 p-5 text-sm leading-6 text-blue-50">
        ...
        return (
            <div>
                ...
                <blockquote
                    className="mt-7 border-l-2 border-amber-300 pl-5 font-serif text-xl font-medium leading-9 text-white sm:text-2xl sm:leading-10">
                    {kural.kural[0]}
                    <br/>
                    {kural.kural[1]}
                </blockquote>
    ...
    return (
        <main
            className="min-h-screen overflow-hidden bg-linear-to-br from-blue-50 via-white to-indigo-50 text-slate-900 selection:bg-amber-200">
            ...
            <div className="relative mx-auto max-w-7xl px-4 pb-16 sm:px-8 lg:px-10">
                <section
                    className="grid items-center gap-12 pb-14 pt-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:pb-20 lg:pt-20">
                    <div className="max-w-2xl">
                        <div
                            className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/70 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-blue-700 shadow-sm backdrop-blur">
                        ...
                        <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
                            Made with love for Thirukkural and Tamil, this is a simple modern doorway to 1,330 couplets
                            on virtue, purpose, and
                    ...
                    <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
                        ...
                        <div
                            className="relative flex aspect-square items-center justify-center rounded-[2.5rem] border border-white/80 bg-white/55 p-8 shadow-2xl shadow-blue-900/10 backdrop-blur-sm sm:p-12">
                            <Image
                            ...
                            />
                            <div
                                className="absolute -bottom-4 -left-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 shadow-lg shadow-amber-900/10 sm:-left-8">
                                <p className="text-xs font-semibold uppercase tracking-widest text-amber-700">Our
                                    motto</p>
                                <p className="mt-1 text-sm font-medium text-amber-950">Made with love. Shared
                                    freely.</p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-14">
                        <div>
                            <div
                                className="mb-5 flex size-12 items-center justify-center rounded-2xl bg-blue-100 text-blue-700">
                                <BookOpen className="size-6"/>
                            </div>
                            <p className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600">A thought to carry
                                with you</p>
                            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-blue-950 sm:text-4xl">Today’s
                                Kural</h2>
                            <p className="mt-4 text-sm leading-6 text-slate-600">
                                Pause for a moment. Read slowly. Find one small way to bring this ancient insight into
                                your day.
                            </p>
                        </div>

                        <div
                            className="rounded-3xl bg-linear-to-br from-blue-700 to-indigo-900 p-6 text-white shadow-xl shadow-blue-900/20 sm:p-9">
                            {dailyKuralContent()}
                        </div>
                    </div>
                </section>

                <section id="about" className="order-3 grid gap-6 py-16 sm:grid-cols-3 sm:py-20">
                    <div className="sm:col-span-2">
                        ...
                        <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight text-blue-950 sm:text-4xl">
                            Keep ancient Tamil wisdom alive in the language of today.
                        </h2>
                    </div>
                    <div className="flex items-center gap-3 text-sm leading-6 text-slate-600">
                        <Heart className="mb-1 size-5 shrink-0 text-red-500"/>
                        <p>Free, simple access to Thirukkural for curious minds everywhere—with Tamil
                            tradition at the heart of it.</p>
                    </div>
                </section>
            </div>
        </main>

...
import { ArrowDown, ArrowRight, BookOpen, Heart, Sparkles } from 'lucide-react';
    ...
    return (
        <main className="min-h-screen overflow-hidden bg-linear-to-br from-blue-50 via-white to-indigo-50 text-slate-900 selection:bg-amber-200">
            ...
            <div className="relative mx-auto max-w-7xl px-4 pb-16 sm:px-8 lg:px-10">
                <section className="grid items-center gap-12 pb-14 pt-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:pb-20 lg:pt-20">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
                            Thirukkural is a timeless Tamil guide to living with virtue, purpose, and compassion. Explore its 1,330 couplets and let a little
                            wisdom shape your day.
                        </p>
                    ...
                    <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
                        ...
                        <div className="relative flex aspect-square items-center justify-center rounded-[2.5rem] border border-white/80 bg-white/55 p-8 shadow-2xl shadow-blue-900/10 backdrop-blur-sm sm:p-12">
                            ...
                            <div className="absolute -bottom-4 -left-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 shadow-lg shadow-amber-900/10 sm:-left-8">
                                ...
                                <p className="mt-1 text-sm font-medium text-amber-950">Wisdom. For everyone.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section
                    id="todays-kural"
                    className="scroll-mt-24 rounded-4xl border border-blue-200/80 bg-white/80 p-5 shadow-2xl shadow-blue-900/10 backdrop-blur sm:p-8 lg:p-12"
                >
                ...
                <section id="about" className="grid gap-6 py-16 sm:grid-cols-3 sm:py-20">
                    <div className="sm:col-span-2">
                        ...
                        <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight text-blue-950 sm:text-4xl">
                            Make the world’s oldest wisdom feel close, useful, and alive.
                        </h2>
                    </div>
                    <div className="flex items-end gap-3 text-sm leading-6 text-slate-600">
                        <Heart className="mb-1 size-5 shrink-0 text-amber-500" /> We’re building a welcoming doorway into Tamil culture and human wisdom—for

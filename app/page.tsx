            ...
            <div className="relative mx-auto max-w-7xl px-4 pb-16 sm:px-8 lg:px-10">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p className="text-xs font-semibold uppercase tracking-widest text-amber-700">Our
                                    motto</p>
                                <p className="mt-1 text-sm font-medium text-amber-950">A small contribution to Tamil. A
                                    timeless gift to everyone.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="about" className="order-3 py-16 sm:py-20">
                    <div className="max-w-3xl">
                        ...
                        <div
                            className="mt-6 flex max-w-2xl items-start gap-3 text-sm leading-6 text-slate-600 sm:text-base">
                            <p>
                                To make the timeless wisdom of Thirukkural freely accessible to everyone through modern
                                technology—helping people learn, preserving Tamil culture, and inspiring generations to
                                come.
                            </p>
                        </div>
                    </div>
